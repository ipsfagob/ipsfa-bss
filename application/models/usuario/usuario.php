...
class Usuario extends CI_Model {
  ...
  function conectar() {
    $this -> load -> database();
    $consulta = 'SELECT usuario.oid, usuario.nomb AS nombre, apel AS apellido, corr AS correo, perfil.enmb AS perfil FROM usuario 
				JOIN _usuarioperfil ON usuario.oid=_usuarioperfil.oidu
				JOIN perfil ON _usuarioperfil.oidp=perfil.oid
