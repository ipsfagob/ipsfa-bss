  ...
  <?php
	...
	foreach ($cita->rs as $k => $val) {
		...
		$cadena .= '<li>
	      ...
	      <a class="waves-effect waves-light modal-trigger" href="#modal1" onclick="setValor(\'' . $val->numero . '\', \'' . $val->codigo . '\', 0);">
	      ...
	      <a href="' . base_url() . 'index.php/BienestarSocial/adjuntos/' . $val->numero . '" class="right">
