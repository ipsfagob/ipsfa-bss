...
<div class="contenedor" >
	...
	<table class="tcontenedor" border=0>
		<tr><td class="textoCenter" style="width:80%;" rowspan="2"><H1>SOLICITUD DE REEMBOLSO<br>POR SERVICOS M&Eacute;DICOS</H1></td><td style="width:20%;" class="biz bde btop bajo">Codigo</td></tr>
	...
	<table class="tcontenedor junta" border=1>
		...
		<tr><td colspan="3" style="width:100%;color:red;" class="textoCenter"><h3>POR FAVOR NO ESCRIBO SOBRE LAS CASILLAS SOMBREADAS</h3></td></tr>
	</table>
